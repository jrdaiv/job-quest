...
@app.route("/<int:hiring_manager_id>", methods=['GET', 'OPTIONS'])
...
@app.route("/update/<int:hiring_manager_id>", methods=['PUT', 'OPTIONS'])
...
@app.route("/delete/<int:hiring_manager_id>", methods=['DELETE', 'OPTIONS'])
